...
refSeqEnsembl_pas = list(sequences_pas$refSeq, sequences_pas$ensembl,sequences_pas$exon,sequences_pas$intron)
names(refSeqEnsembl_pas) = c("refSeq","ensembl","exon","intron")
...
refSeqEnsembl_nopas = list(sequences_noPas$refSeq, sequences_noPas$ensembl,sequences_noPas$exon,sequences_noPas$intron)
